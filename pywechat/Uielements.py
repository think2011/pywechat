...
class Lists():
    def __init__(self,language=language):
        ...
        if self.language=='简体中文':
            ...
            self.PhotoAndVideoList={'title':'图片和视频','control_type':'List'}#微信聊天记录窗口中选择图片与视频后的列表 
...
class Windows():
    def __init__(self,language=language):
        ...
        if self.language=='简体中文':
            ...
            self.SaveFileWindow={'title_re':'另存为','control_type':'Window','framework_id':'Win32','top_level_only':False}#保存文件时的窗口
