...
class Messages():
    ...
    def send_message_to_friend(friend:str,message:str,delay:float=1,tickle:bool=False,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用于给单个好友或群聊发送单条信息\n
        :param: friend:\t好友或群聊备注。格式:friend="好友或群聊备注"\n
        :param: message:\t待发送消息。格式:message="消息"\n
        :param: tickle:\t是否在发送消息或文件后拍一拍好友,默认为False\n
        :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。
        ...
        :param: is_maximize:\t微信界面是否全屏,默认全屏。\n
        :param: delay:\t发送单条消息延迟,单位:秒/s,默认1s。\n
        :param: search_pages:\t在会话列表中查询查找好友时滚动列表的次数,默认为10,一次可查询5-12人,当search_pages为0时,直接从顶部搜索栏搜索好友信息打开聊天界面\n
        :param: close_wechat:\t任务结束后是否关闭微信,默认关闭\n
        '''
        if len(message)==0:
    ...
    def send_messages_to_friend(friend:str,messages:list[str],tickle:bool=False,delay:float=1,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        ...
        该方法用于给单个好友或群聊发送多条信息\n
        :param: friend:\t好友或群聊备注。格式:friend="好友或群聊备注"\n
        :param: message:\t待发送消息列表。格式:message=["发给好友的消息1","发给好友的消息2"]\n
        :param: tickle:\t是否在发送消息或文件后拍一拍好友,默认为False\n
        :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
            若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
    ...
    def send_messages_to_friends(friends:list[str],messages:list[list[str]],tickle:list[bool]=[],delay:float=1,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用于给多个好友或群聊发送多条信息\n
        :param: friends:\t好友或群聊备注列表,格式:firends=["好友1","好友2","好友3"]。\n
        :param: messages:\t待发送消息,格式: message=[[发给好友1的多条消息],[发给好友2的多条消息],[发给好友3的多条信息]]。\n
        :param: tickle:\t是否给每一个好友发送消息或文件后拍一拍好友,格式为:[True,True,False,...]的bool值列表,与friends列表中的每一个好友对应\n
        :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
            若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
        :param: is_maximize:\t微信界面是否全屏,默认全屏。\n
    ...
    def send_message_to_friends(friends:list[str],message:list[str],tickle:list[bool]=[],delay:float=1,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        ...
        :param: friends:\t好友或群聊备注。格式:friends=["好友1","好友2","好友3"]\n
        :param: message:\t待发送消息,格式: message=[发给好友1的多条消息,发给好友2的多条消息,发给好友3的多条消息]。\n
        :param: tickle:\t是否给每一个好友发送消息或文件后拍一拍好友,格式为:[True,True,False,...]的bool值列表,与friends列表中的每一个好友对应\n
        :param: delay:\t发送单条消息延迟,单位:秒/s,默认1s。\n
        :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
    ...
    @staticmethod
    def forward_message(friends:list[str],message:str,delay:float=1,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用于给好友转发消息\n
        :param: friends:\t好友或群聊备注列表。格式:friends=["好友1","好友2","好友3"]\n
        :param: message:\t待发送消息,格式: message="转发消息"。\n
        :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
            若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
        :param: is_maximize:\t微信界面是否全屏,默认全屏。\n
        :param: search_pages:\t在会话列表中查询查找带转发消息的第一个好友时滚动列表的次数,默认为10,一次可查询5-12人,当search_pages为0时,直接从顶部搜索栏搜索好友信息打开聊天界面\n
        :param: close_wechat:\t任务结束后是否关闭微信,默认关闭\n
        '''
        if len(message)==0:
            raise CantSendEmptyMessageError
...
class Files():
    @staticmethod
    def send_file_to_friend(friend:str,file_path:str,with_messages:bool=False,messages:list=[],message_first:bool=False,delay:float=1,tickle:bool=False,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用于给单个好友或群聊发送单个文件\n
        :param: friend:\t好友或群聊备注。格式:friend="好友或群聊备注"\n
        :param: file_path:\t待发送文件绝对路径。\n
        :param: with_messages:\t发送文件时是否给好友发消息。True发送消息,默认为False\n
        :param: messages:\t与文件一同发送的消息。格式:message=["消息1","消息2","消息3"]\n
        :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
            若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
        :param: is_maximize:\t微信界面是否全屏,默认全屏。\n
        :param: delay:\t发送单条信息或文件的延迟,单位:秒/s,默认2s。\n
        :param: tickle:\t是否在发送消息或文件后拍一拍好友,默认为False\n
        :param: messages_first:\t默认先发送文件后发送消息,messages_first设置为True,先发送消息,后发送文件,\n
        :param: search_pages:\t在会话列表中查询查找好友时滚动列表的次数,默认为10,一次可查询5-12人,当search_pages为0时,直接从顶部搜索栏法搜索好友信息打开聊天界面\n
        :param: close_wechat:\t任务结束后是否关闭微信,默认关闭\n
        '''
        if len(file_path)==0:
            raise NotFileError
    ...
    def send_files_to_friend(friend:str,folder_path:str,with_messages:bool=False,messages:list=[str],messages_first:bool=False,delay:float=1,tickle:bool=False,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True,search_pages:int=10):
        ...
        该方法用于给单个好友或群聊发送多个文件\n
        :param: friend:\t好友或群聊备注。格式:friend="好友或群聊备注"\n
        :param: folder_path:\t所有待发送文件所处的文件夹的地址。\n
        :param: with_messages:\t发送文件时是否给好友发消息。True发送消息,默认为False。\n
        :param: messages:\t与文件一同发送的消息。格式:message=["消息1","消息2","消息3"]\n
        :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
        ...
        :param: is_maximize:\t微信界面是否全屏,默认全屏。
        :param: delay:\t发送单条信息或文件的延迟,单位:秒/s,默认2s。\n
        :param: tickle:\t是否在发送文件或消息后拍一拍好友,默认为False\n
        :param: messages_first:\t默认先发送文件后发送消息,messages_first设置为True,先发送消息,后发送文件,\n
        :param: search_pages:\t在会话列表中查询查找好友时滚动列表的次数,默认为10,一次可查询5-12人,当search_pages为0时,直接从顶部搜索栏搜索好友信息打开聊天界面\n
    ...
    def send_file_to_friends(friends:list[str],file_paths:list[str],with_messages:bool=False,messages:list[list[str]]=[],message_first:bool=False,delay:float=1,tickle:list[bool]=[],wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        ...
        :param: friends:\t好友或群聊备注。格式:friends=["好友1","好友2","好友3"]\n
        :param: file_paths:\t待发送文件,格式: file=[发给好友1的单个文件,发给好友2的文件,发给好友3的文件]。\n
        :param: with_messages:\t发送文件时是否给好友发消息。True发送消息,默认为False\n
        :param: messages:\t待发送消息,格式:messages=["发给好友1的单条消息","发给好友2的单条消息","发给好友3的单条消息"]
        :param: message_first:\t先发送消息还是先发送文件.默认先发送文件\n
        :param: delay:\t发送单条消息延迟,单位:秒/s,默认1s。\n
        :param: tickle:\t是否给每一个好友发送消息或文件后拍一拍好友,格式为:[True,True,False,...]的bool值列表,与friends列表中的每一个好友对应\n
        :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
    ...
    def send_files_to_friends(friends:list[str],folder_paths:list[str],with_messages:bool=False,messages:list[list[str]]=[],message_first:bool=False,delay:float=1,tickle:list[bool]=[],wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        ...
        :param: friends:\t好友或群聊备注。格式:friends=["好友1","好友2","好友3"]\n
        :param: folder_paths:\t待发送文件夹路径列表,每个文件夹内可以存放多个文件,格式: FolderPath_list=["","",""]\n
        :param: with_messages:\t发送文件时是否给好友发消息。True发送消息,默认为False\n
        :param: message_list:\t待发送消息,格式:message=[[""],[""],[""]]\n
        :param: message_first:\t先发送消息还是先发送文件,默认先发送文件\n
        :param: delay:\t发送单条消息延迟,单位:秒/s,默认1s。\n
        :param: tickle:\t是否给每一个好友发送消息或文件后拍一拍好友,格式为:[True,True,False,...]的bool值列表,与friends列表中的每一个好友对应\n
        :param:  wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。
    ...
    @staticmethod
    def forward_file(friends:list[str],file_path:str,delay:float=1,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来给多个好友或群聊转发同一个文件\n
        :param: friends:\t好友或群聊备注列表。格式:friends=["好友1","好友2","好友3"]\n
        :param: file_path:\t待发送文件,格式: file_path="转发文件路径"。\n
        :param: delay:发送单条消息延迟,单位:秒/s,默认1s。\n
        :param: wechat_path:微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
            若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
        :param: is_maximize:微信界面是否全屏,默认全屏。\n
        :param: search_pages:在会话列表中查询查找第一个转发文件的好友时滚动列表的次数,默认为10,一次可查询5-12人,当search_pages为0时,直接从顶部搜索栏搜索好友信息打开聊天界面\n
        :param: close_wechat:任务结束后是否关闭微信,默认关闭\n
        '''
        ...
        if close_wechat:
            main_window.close()
    @staticmethod
    def get_chat_files(friend:str,folder_path:str,number:int=10,wechat_path:str=None,is_maximize:bool=False,close_wechat:bool=True):
        '''
        该方法用来保存与某个好友的聊天文件。\n'
        :param: friend:\t好友或群聊的备注\n
        :param: folder_path:\t用来保存聊天文件的文件夹路径\n
        :param: number:\t要保存的文件数量\n
        :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
            若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
        :param: is_maximize:\t微信界面是否全屏,默认全屏。\n
...
class WechatSettings():
    ...
    def Auto_convert_voice_messages_to_text(state:str='open',wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True,close_settings_window:bool=True):
        ...
        :param: state:\t决定是否开启或关闭某项设置,取值:'close','open',默认为open\n
        :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
            若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
        :param: is_maximize:\t微信界面是否全屏,默认全屏。\n
        :param: close_wechat:\t任务结束后是否关闭微信,默认关闭\n
        :param: close_settings_window:\t任务完成后是否关闭设置界面窗口,默认关闭\n
        '''
        choices={'open','close'}
    ...
    def New_message_alert_sound(state:str='open',wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True,close_settings_window:bool=True):
        ...
        :param: state:\t决定是否开启或关闭某项设置,取值:'close','open',默认为open\n
        :param: swechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
            若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
        :param: is_maximize:\t微信界面是否全屏,默认全屏。\n
        :param  close_wechat:\t任务结束后是否关闭微信,默认关闭\n
    ...
    def Change_capture_screen_shortcut(shortcuts:list[str],wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True,close_settings_window:bool=True):
        ...
        :param: shortcuts:\t快捷键键位名称列表,若你想将截取屏幕的快捷键设置为'ctrl+shift',那么shortcuts=['ctrl','shift']\n
        :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
            若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
        :param: is_maximize:\t微信界面是否全屏,默认全屏。\n
    ...
    def Change_send_message_shortcut(shortcuts:str='Enter',wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True,close_settings_window:bool=True):
        ...
        :param: shortcuts:\t快捷键键位名称,发送消息的快捷键只有enter与ctrl+enter。\n
        :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
            若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
        :param: is_maximize:\t微信界面是否全屏,默认全屏。\n
...
class Call():
    ...
    def voice_call_in_group(group_name:str,friends:list[str],search_pages:int=10,wechat_path=None,is_maximize:bool=True,close_wechat:bool=True,):
        '''
        该方法用来在群聊中发起语音电话\n
        :param: group_name:\t群聊备注.\n
        :param: friends:\t所有要呼叫的群友备注\n
        :param: search_pages:\t在会话列表中查询查找好友时滚动列表的次数,默认为10,一次可查询5-12人,当search_pages为0时,直接从顶部搜索栏搜索好友信息打开聊天界面\n
        :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
            若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
        :param: is_maximize:\t微信界面是否全屏,默认全屏。\n
        :param: lose_wechat:\t任务结束后是否关闭微信,默认关闭\n
        '''
...
class FriendSettings():
    ...
    @staticmethod
    def set_friend_as_star_friend(friend:str,search_pages,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来将好友设置为星标朋友\n
        :param: friend:好友备注。\n
        :param: search_pages:\t在会话列表中查询查找好友时滚动列表的次数,默认为10,一次可查询5-12人,当search_pages为0时,直接从顶部搜索栏搜索好友信息打开聊天界面\n
    ...
    def change_friend_privacy(friend:str,privacy:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        ...
        该方法用来修改好友权限\n
        :param friend:好友备注。\n
        :param privacy:好友权限,共有：仅聊天',"聊天、朋友圈、微信运动等",'不让他（她）看',"不看他（她）"四种\n
        :param: search_pages:\t在会话列表中查询查找好友时滚动列表的次数,默认为10,一次可查询5-12人,当search_pages为0时,直接从顶部搜索栏搜索好友信息打开聊天界面\n
        :param wechat_path:微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
            若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
    ...
    def share_contact(friend:str,others:list[str],search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用来推荐好友给其他人\n
        :param: friend:\t被推荐好友备注\n
        :param: others:\t推荐人备注列表\n
        :param: search_pages:\t在会话列表中查询查找好友时滚动列表的次数,默认为10,一次可查询5-12人,当search_pages为0时,直接从顶部搜索栏搜索好友信息打开聊天界面\n
        :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
            若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
    ...
    def get_friends_wechat_numbers(friends:list[str],wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法根据微信备注获取多个好友微信号\n
        :param: friends:\t所有待获取微信号的好友的备注列表。\n
        :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
            若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
        :param: is_maximize:\t微信界面是否全屏,默认全屏。\n
    ...
    def get_chat_history(friend:str,number:int=10,capture_screen:bool=False,folder_path:str=None,search_pages:int=10,wechat_path:str=None,is_maximize:bool=False,close_wechat:bool=True):
        '''
        该方法用来获取好友或群聊的聊天记录\n
        :param: friend:\t好友或群聊备注或昵称\n
        :param: number:\t待获取的聊天记录条数,默认10条\n
        :param: capture_scren:\t聊天记录是否截屏,默认不截屏\n
        :param: folder_path:\t存放聊天记录截屏图片的文件夹路径\n
        :param: search_pages:\t在会话列表中查询查找好友时滚动列表的次数,默认为10,一次可查询5-12人,当search_pages为0时,直接从顶部搜索栏搜索好友信息打开聊天界面\n
        :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
            若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
...
class GroupSettings():
    ...
    def create_group_chat(friends:list[str],group_name:str=None,wechat_path:str=None,is_maximize:bool=True,messages:list=[],close_wechat:bool=True):
        '''
        该方法用来新建群聊\n
        :param: friends:\t新群聊的好友备注列表。\n
        :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
            若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
        :param: is_maximize:\t微信界面是否全屏,默认全屏。\n
        :param: close_wechat:\t任务结束后是否关闭微信,默认关闭\n
        :param: messages:\t建群后是否发送消息,messages非空列表,在建群后会发送消息\n
        '''
        if len(friends)<=2:
    ...
    def change_group_name(group_name:str,change_name:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        ...
        group_chat_settings_window,main_window=Tools.open_group_settings(group=group_name,wechat_path=wechat_path,is_maximize=is_maximize,search_pages=search_pages)
    ...
    def cancel_mute_group_notifications(group_name:str,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        ...
        :param: swechat_path:微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数\n
            若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
        :param: sis_maximize:\t微信界面是否全屏,默认全屏。
        :param: sclose_wechat:\t任务结束后是否关闭微信,默认关闭\n
        '''
        group_chat_settings_window,main_window=Tools.open_group_settings(group=group_name,wechat_path=wechat_path,is_maximize=is_maximize,search_pages=search_pages)
        mute_checkbox=group_chat_settings_window.child_window(title="消息免打扰",control_type="CheckBox")
        if not mute_checkbox.get_toggle_state():
...
class Contacts():
    ...
    def get_groups_info(wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        ...
        结果以json格式返回\n
        :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
        :param: 这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
            若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
        :param: is_maximize:\t微信界面是否全屏,默认全屏。\n
        :param: close_wechat:\t任务结束后是否关闭微信,默认关闭\n
        '''
...
class AutoReply():
    ...
    def auto_answer_call(duration:str,broadcast_content:str,message:str=None,times:int=2,wechat_path:str=None,close_wechat:bool=True):
        ...
        :param: duration:\t自动接听功能持续时长,格式:s,min,h分别对应秒,分钟,小时,例:duration='1.5h'持续1.5小时\n
        :param: broadcast_content:\twindowsAPI语音播报内容\n
        :param: message:\t语音播报结束挂断后,给呼叫者发送的留言\n
        :param: times:\t语音播报重复次数\n
        :param: close_wechat:\t任务结束后是否关闭微信,默认关闭\n
        '''
    ...
    def auto_reply_messages(content:str,duration:str,never_reply:list=[],wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        ...
        :param: duration:\t自动回复持续时长,格式:'s','min','h'单位:s/秒,min/分,h/小时\n
        :param: never_reply:\t在never_reply列表中的好友即使有新消息时也不会回复\n
        :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
            若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
        :param: is_maximize:\t微信界面是否全屏,默认全屏。\n
    ...
    def auto_reply_to_friend(friend:str,duration:str,content:str,save_chat_history:bool=False,capture_screen:bool=False,folder_path:str=None,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        ...
        :param: friend:\t好友或群聊备注\n
        :param: duration:\t自动回复持续时长,格式:'s','min','h'单位:s/秒,min/分,h/小时\n
        :param: content:\t指定的回复内容，比如:自动回复[微信机器人]:您好,我当前不在,请您稍后再试。\n
        :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
            若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
        :param: is_maximize:\t微信界面是否全屏,默认全屏。\n
    ...
    def AI_auto_reply_to_friend(friend:str,duration:str,AI_engine,search_pages:int=10,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        ...
        :param: friend:\t好友或群聊备注\n
        :param: duration:\t自动回复持续时长,格式:'s','min','h'单位:s/秒,min/分,h/小时\n
        :param: Ai_engine:\t调用的AI大模型API函数,去各个大模型官网找就可以\n
        :param: search_pages:\t在会话列表中查询查找好友时滚动列表的次数,默认为10,一次可查询5-12人,当search_pages为0时,直接从顶部搜索栏法搜索好友信息打开聊天界面\n
        :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
            这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
            若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
...
def get_friends_names(wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
    '''
    该函数用来获取通讯录中所有好友的名称与昵称。速率大约为1秒获取20个好友的信息\n
    结果以json格式返回\n
    :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
        这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需传入该参数
        若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
...
def create_an_new_note(content:str=None,file:str=None,wechat_path:str=None,is_maximize:bool=True,content_first:bool=True,close_wechat:bool=True):
    ...
    :param: wechat_path:\t微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
        ...
        若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！
    :param: is_maximize:\t微信界面是否全屏,默认全屏。\n
    :param: content_first:\t先写文本内容还是先放置文件\n
    :param: close_wechat:\t任务结束后是否关闭微信,默认关闭\n
    '''
