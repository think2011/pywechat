...
class Messages():
    @staticmethod
    def send_message_to_friend(friend:str,message:str,wechat_path:str=None,delay:int=2,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用于给单个好友或群聊发送单条信息\n
    ...
    @staticmethod
    def send_messages_to_friend(friend:str,messages:list[str],delay:int=2,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用于给单个好友或群聊发送多条信息\n
        friend:好友或群聊备注。格式:friend="好友或群聊备注"\n
    ...
    @staticmethod
    def send_messages_to_firends(friends:list[str],messages:list[list[str]],wechat_path:str=None,delay:int=2,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用于给多个好友或群聊发送多条信息\n
    ...
    @staticmethod
    def send_message_to_friends(friends:list[str],message:list[str],wechat_path:str=None,delay:int=2,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用于给多个好友或群聊发送单条信息\n
    ...
    @staticmethod
    def forward_message(friends:list[str],message:str,wechat_path:str=None,close_wechat:bool=True):
        '''
        该方法用于给多个好友或群聊转发单条信息\n
...
class Files():
    @staticmethod
    def send_file_to_friend(friend:str,file_path:str,wechat_path:str=None,delay:int=2,is_maximize:bool=True,with_messages:bool=False,messages:list=[],message_first:bool=False,close_wechat:bool=True):
        '''
        该方法用于给单个好友或群聊发送单个文件\n
        friend:好友或群聊备注。格式:friend="好友或群聊备注"\n
        file_path:待发送文件绝对路径。
    ...
    @staticmethod
    def send_files_to_friend(friend:str,folder_path:str,wechat_path:str=None,delay:int=2,is_maximize:bool=True,with_messages:bool=False,messages:list=[],messages_first:bool=False,close_wechat:bool=True):
        '''
        该方法用于给单个好友或群聊发送多个文件\n
        friend:好友或群聊备注。格式:friend="好友或群聊备注"\n
    ...
    @staticmethod
    def send_file_to_friends(friends:list[str],file_paths:list[str],wechat_path:str=None,delay:int=2,is_maximize:bool=True,with_messages:bool=False,messages:list[list[str]]=[],message_first:bool=False,close_wechat:bool=True):
        '''
    ...
    @staticmethod
    def send_files_to_friends(friends:list[str],folder_paths:list[str],wechat_path:str=None,delay:int=2,is_maximize:bool=True,with_messages:bool=False,messages:list[list[str]]=[],message_first:bool=False,close_wechat:bool=True):
        '''
    ...
    @staticmethod
    def forward_file(friends:list[str],file_path:str,message:str,wechat_path:str=None,is_maximize:bool=True,with_messages:bool=False,message_first:bool=False,close_wechat:bool=True):
        '''
        friends:好友或群聊备注列表。格式:friends=["好友1","好友2","好友3"]\n
...
class WechatSettings():
    ...
    @staticmethod
    def convert_to_text(wechat_path:str=None,is_maximize:bool=True):
        '''
        wechat_path:微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
        这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需任何参数\n
        若你没有设置微信的Wechat.exe地址为环境变量,那么你需要传入该文件地址作为参数否则会引发错误无法打开微信！\n
        ...
        该方法用来PC微信打开自动语音转文字。\n
        '''
        settings=Tools.open_wechat_settings(wechat_path=wechat_path,is_maximiz=is_maximize)
    ...
    def clear_chat_history(wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        ...
        该方法用来PC微信打开自动语音转文字。\n
        '''
        settings=Tools.open_wechat_settings(wechat_path=wechat_path,is_maximize=is_maximize)
        general_settings=settings.child_window(title="通用设置",control_type="TabItem")
        general_settings.click_input()
...
class Call():
    @staticmethod
    def voice_call(friend,wechat_path=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        friend:好友备注\n
        wechat_path:微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
        这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需任何参数\n
    ...
    def video_call(friend,wechat_path=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        friend:好友备注.\n
        wechat_path:微信的WeChat.exe文件地址,当微信未登录时,该函数使用此地址启动微信并点击登录完成打开微信界面。\n
        这里强烈建议将微信路径加入到windows环境变量中,因为该函数默认使用windows环境变量中的Wechat.exe路径启动微信,此时调用该函数无需任何参数\n
